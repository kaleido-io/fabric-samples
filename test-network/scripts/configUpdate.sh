...
fetchChannelConfig() {
  ...
  set -x
  peer channel fetch config config_block.pb -o ec2-3-135-215-240.us-east-2.compute.amazonaws.com:7050 --ordererTLSHostnameOverride ec2-3-135-215-240.us-east-2.compute.amazonaws.com -c $CHANNEL --tls --cafile "$ORDERER_CA"
  { set +x; } 2>/dev/null
